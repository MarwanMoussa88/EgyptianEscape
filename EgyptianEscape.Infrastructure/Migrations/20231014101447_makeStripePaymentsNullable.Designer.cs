...
namespace EgyptianEscape.Infrastructure.Migrations
{
    ...
    [Migration("20231014101447_makeStripePaymentsNullable")]
    partial class makeStripePaymentsNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EgyptianEscape.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EgyptianEscape.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EgyptianEscape.Domain.Entities.Booking", b =>
                {
                    b.HasOne("EgyptianEscape.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EgyptianEscape.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
